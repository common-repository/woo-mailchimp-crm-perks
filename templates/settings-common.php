...
display: inline; 
  ...
  jQuery(document).ready(function($){
    ...
    if(unsaved) return '<?php esc_html_e('Changes you made may not be saved','woo-mailchimp-crm-perks'); ?>';
});
          // Tooltips
  var tiptip_args = {
  'attribute' : 'data-tip',
  ...
  $(this).text('<?php esc_html_e('Show Key','woo-mailchimp-crm-perks') ?>');  
  $(this).removeClass('vx_hidden');
  key.attr('type','password');  
  }else{
  $(this).text('<?php esc_html_e('Hide Key','woo-mailchimp-crm-perks') ?>');  
